...
class TestAuthenticatedHttpRequestBuilderImpl {
    ...
    void testAddTokenIfValid() {
        ...
        IOException exception =
            assertThrows(IOException.class, () -> new AuthenticatedHttpRequestBuilderImpl(buildConnectionInfo(), "endpoint", oAuth2Token));
    ...
    void testExpiredToken() {
        ...
        IOException exception = assertThrows(IOException.class, () -> new AuthenticatedHttpRequestBuilderImpl(buildConnectionInfo(), "endpoint", oAuth2Token));
    ...
    void testConstructor() throws IOException {
        ...
        AuthenticatedHttpRequestBuilderImpl requestBuilder = new AuthenticatedHttpRequestBuilderImpl(buildConnectionInfo(), "endpoint", oAuth2Token);
